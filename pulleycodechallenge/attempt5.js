      ...
      xhr1.onload = () => {
        if (xhr1.readyState == 4 && xhr1.status == 200) {
          ...
          setTimeout(() => {
            ...
            const startquotelevel2 = "\"";
            const endquotelevel2 = "\"";
            const strtempforlevel2 = xhr1.response.encrypted_path.slice(5);
            const strtempforlevel2withquotes = "".concat(startquotelevel2, strtempforlevel2, endquotelevel2);
            console.log("ready for decoding string", strtempforlevel2withquotes);
            console.log("typeof strtempforlevel2withquotes", typeof strtempforlevel2withquotes);
            const str2forlevel2 = atob(strtempforlevel2withquotes);
